package com.ajit.assuranceprojet.reponse;

import com.ajit.assuranceprojet.LoggingClass.LogginClass;
...
public class GlobalControllerExceptionHandler {
   ...
   @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    ...
    public ApiErrorResponse monexeception(Exception ex) {
        LogginClass.LOG.info("Nom de l'exception non geree "+ex.getClass().getName());
        LogginClass.LOG.info("Message de l'exception "+ex.getMessage());
